...
export default function Findings() {
  ...
  const requestExport = (format: "markdown" | "pdf") => {
    if (isDirty) {
      toast.error("Save findings before exporting a report");
      return;
    }
    if (selectedExperimentId) exportReport.mutate({ experimentId: selectedExperimentId, format });
  };
