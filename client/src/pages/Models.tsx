      ...
      <div className="grid gap-5 xl:grid-cols-[0.9fr_1.4fr]">
        <form onSubmit={submit} className="rounded-2xl border border-white/8 bg-slate-900/40 p-6">
          ...
          <div className="mt-6 space-y-4">
            ...
            <div><Label htmlFor="hyperparameters">Hyperparameters (JSON; optional _huggingFaceJob)</Label><Textarea id="hyperparameters" value={hyperparameters} onChange={event => setHyperparameters(event.target.value)} className="mt-1.5 min-h-36 font-mono text-xs border-white/10 bg-slate-950/50 text-white" required /></div>
          </div>
